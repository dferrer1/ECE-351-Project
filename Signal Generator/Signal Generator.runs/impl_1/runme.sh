...
HD_PWD='D:/.GitHub/ECE-351-Project/Signal Generator/Signal Generator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Phase_accumulator_for_diego_ref.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Phase_accumulator_for_diego_ref.tcl -notrace
