...
HD_PWD='D:/.GitHub/ECE-351-Project/Signal Generator/Signal Generator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Phase_accumulator_for_diego_ref.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Phase_accumulator_for_diego_ref.tcl
